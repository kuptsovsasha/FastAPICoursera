...
from storeapp.config import DevConfig, get_config
    ...
    dictConfig(
        {
            ...
            "formatters": {
                ...
                "file": {
                    ...
                    "format": "%(asctime)s %(msecs)03d %(levelname)s %(name)s %(correlation_id)s %(lineno)d %(message)s",
                },
            },
            "handlers": {
                "default": {
                ...
                "logtail": {
                    ...
                    "host": "s1570703.eu-nbg-2.betterstackdata.com",
                },
                "rotating_file": {
